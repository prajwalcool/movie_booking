...
<div id="now" class="mv-slides container-fluid">
    ...
    <hr>
    <div id="<?= getLanguages()['0']?>" class="carousel slide carousel-multi-item mb-3" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active">
                ...
                <div class="col-md-4 float-left">
                    <div class="card">
                        <div class="card-img-top">
                            <img src="img/mv/<?= getSanitizeName(getMovieNamesByLang(getLanguages()[0])[0]) ?>.jpg">
                        </div>
                        <div class="card-body">
                            <div class="card-left">
                                <div class="card-title">
                                    <h4><?=getMovieNamesByLang(getLanguages()[0])[0]?></h4>
                                </div>
                                <p class="card-subtitle text-black-50"><?=getCertificate(getMovieNamesByLang(getLanguages()[0])[0])[0]?> | <?= getLanguages()[0]?></p>
                            </div>
                ...
                <div class="col-md-4 float-left d-none d-md-block">
                    <div class="card ">
                        <div class="card-img-top">
